      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">Pages & Screens</h1>
                    <p className="text-sm text-gray-600">Analyze page performance and user navigation</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {credentials.length === 0 ? (
              ...
              <CardContent className="p-12 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-600 mb-4 max-w-md">
                    Connect your Google Analytics account to start analyzing page performance and user navigation.
                  </p>
                  <Button
            ...
            <PagesAndScreens propertyId={selectedProperty} />
          )}
        </div>
      </div>
    </Layout>
...
export default PagesScreensAnalyticsPage;